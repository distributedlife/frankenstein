...
public class RemoteFrankensteinDriverTest extends MockObjectTestCase {
    ...
    public void testConnectRetriesConnection() {
        ...
        RemoteFrankensteinDriver frankensteinDriver = new RemoteFrankensteinDriver("127.0.0.1", 5678);
    ...
    public void testRunWillNotRepeatIndefinitely() {
        SocketImpl[] testSockets = new SocketImpl[RemoteFrankensteinDriver.MAX_TRIES + 1];
        for (int i = 0; i < RemoteFrankensteinDriver.MAX_TRIES; i++) {
        ...
        testSockets[RemoteFrankensteinDriver.MAX_TRIES] = last_socket;
        ...
        try {
            ...
            assertTrue("message didn't match pattern:" + e.getMessage(), e.getMessage().matches("Tried " + RemoteFrankensteinDriver.MAX_TRIES + " times.*"));
